...
const getNumberOfNeighborBombs = (bombBoard, numberOfRowsIndex, numberOfColumnsIndex) => {
  ...
  const neighborRowIndex = numberOfRowsIndex += offset[0];
  const neighborColumnIndex = numberOfColumnsIndex += offset[0];
